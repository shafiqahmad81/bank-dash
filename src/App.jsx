function App() {
  return (
    <div className="min-w-[300px]">
      ...
      <aside className="hidden min-w-[300px] bg-gray-200 absolute top-0 z-50 w-full font-medium h-screen">
        <div className="w-58 lg:w-62 pl-6.1 lg:pl-9.5 pr-20 py-6 lg:p-8 ">
          <div className="flex items-center">
            <img src="../src/assets/images/logo.png" alt="Logo Image" />
            <span className=" font-mont font-black text-2.1xl ml-2 text-[#343C6A ] leading-8">
              BankDash.
        ...
        <div className=" max-h-screen overflow-y-auto">
          <ul>
            ...
            <li className=" relative py-4 pl-11 text-lg leading-5 hover:text-blue transition-all duration-300  before:w-2 before:h-full text-gray-1 before:bg-gray-200 before:absolute before:left-0 before:top-0 before:rounded-r-10 before:transition-all before:duration-300 ">
              <a className=" flex items-center gap-6.5" href="#">
                <svg
                  width="25"
                  height="25"
